...
public class CoursePlanningGraph {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("資料結構->數理統計=" + plan.addPrerequisite("資料結構", "數理統計"));
        ...
        System.out.println("reachable 數理統計->計概=" + plan.reachable("數理統計", "計概"));
        ...
        System.out.println("循環後reachable 資料庫->數理統計=" + plan.reachable("資料庫", "數理統計"));
        plan.impactReport("計概");
        plan.impactReport("微積分");
